...
const PrincipalPage = () => {
    ...
    const [categoriaSeleccionada, setCategoriaSeleccionada] = useState('All');  // 'Todo' es la categoría predeterminada
    ...
    return (
        <div className='principalPage'>
            ...
            <section id='/podcast' className="bg-je-blue w-full pt-12 md:pt-20 rounded-6xl flex flex-col justify-start items-center">
                <div className="md:h-1/2 bg-je-white max-w-screen-xl mx-4 md:mx-4 flex flex-col md:flex-row gap-6 md:gap-8 rounded-6xl p-2 md:p-8 overflow-hidden justify-center items-center">
                    <div className="flex flex-col justify-center w-full md:w-1/2 p-2">
                        ...
                        <span className="text-l md:text-2xl text-je-black mb-4 font-bold text-left slide-in" style={{ fontFamily: 'Space Grotesk' }}>{t('podcast.description')}</span>
                    </div>
            ...
            <section id='/recursos' className="w-full">
                ...
                <div className="flex md:flex-col gap-6 md:gap-8 rounded-b-6xl p-2 overflow-hidden justify-center md:justify-start md:items-center mx-4">
                        ...
                        <ul className="flex flex-col md:flex-row md:gap-16 md:justify-center">
