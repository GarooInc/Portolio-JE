    ...
    return (
        <div className='principalPage'>
            ...
            <section id='/' className="bg-je-blue w-full h-screen pt-12 md:pt-20 rounded-b-6xl flex items-center justify-center">
                <div className="w-full max-w-screen-xl mx-4 md:mx-auto flex flex-col md:flex-row gap-2 md:gap-8 rounded-6xl p-4 md:p-8">
                    <img src="/images/profilepic.jpg" alt="Logo" className="mt-6 w-full md:w-1/2 h-full md:h-auto object-cover rounded-6xl"/>
