  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50 bg-je-blue">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <a href="#" className="-m-1.5 p-0 text-white font-extrabold text-[40px] leading-[48px] " style={{ fontFamily: 'Space Grotesk' }}>
            JE
          </a>
          </div>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-0 text-je-black font-extrabold text-[40px] leading-[48px] " style={{ fontFamily: 'Space Grotesk' }}>
                JE
              </a>
              <button
                type="button"
